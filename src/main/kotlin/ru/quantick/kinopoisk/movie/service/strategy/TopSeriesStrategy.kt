...
@Service
class TopSeriesStrategy(
    val movieProvider: MovieProvider
) : TopMovieStrategy {
    override fun findTop(): List<Movie> = movieProvider.findTopSeries()
    override fun supports(movieStrategy: MovieStrategy): Boolean = movieStrategy == MovieStrategy.TOP_SERIES
}
